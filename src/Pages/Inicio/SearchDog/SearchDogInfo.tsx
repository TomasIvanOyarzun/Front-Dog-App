  ...
  return (
    <Box id='search' width='100%' height={width > 900 ? '800px' : '100%'}  display='flex' bgcolor='#f6f6f6' >
     ...
     <Container  sx={{ display:'flex', alignItems:'center'}}>
         ...
         <Typography color='#895799' variant='h3' fontWeight='700' marginTop={width < 900 ? '30px' : '0'}>Find your favorite breed</Typography>
        ...
        <Grid item xs={12} md={7} lg={7} >
          ...
          <Stack height={width > 700 ? '400px' : '100%'}  display='flex'  flexDirection='column' justifyContent={width > 700 ? 'space-evenly' : 'center'}   >
            ...
            <Box display='flex' marginBottom='12px' flexWrap='wrap' >
               ...
               <Avatar sx={{ width: 90, height: 90, bgcolor: '#895799' }}><PetsIcon fontSize='large'/></Avatar>
               </Box>
               <Box  width={width > 700 ? '85%' : '100%'} >
                <Typography color='#895799' variant='h5' fontWeight='500' >FIND YOUR FAVORITE BREED</Typography>
            ...
            <Box display='flex' marginBottom='12px' flexWrap='wrap' >
               ...
               <Box  width={width > 700 ? '85%' : '100%'} >
                <Typography color='#895799' variant='h5' fontWeight='500' >CREATE YOUR OWN BREED OF DOG</Typography>
            ...
            <Box display='flex' marginBottom='12px' flexWrap='wrap' >
               ...
               <Box  width={width > 700 ? '85%' : '100%'} >
                <Typography color='#895799' variant='h5' fontWeight='500' >SAVE YOUR FAVORITE BREED</Typography>
      ...
      <Link to='/home' style={{listStyle : 'none', textDecoration: 'none'}} >  <Button sx={{backgroundColor: '#530D69', color: '#fff', borderRadius: '2px' , width :'100%' , height: '45px', margin: '20px'}}>see more breeds</Button></Link> 
         </Box>
     </Container>
  </Box>
  )
