...
const Developer = () => {
  ...
  return (
    ...
    <Box display='flex' justifyContent='center' alignItems='center' width='100%' height='500px' sx={{backgroundColor: 'rgb(147, 88, 166, 0.7)'}}>
              <Box width={width > 1450 ? '40%' : '80%'} height='50%' display='flex'  justifyContent='space-evenly' alignItems='center' flexDirection='column'>
                 <Typography color='#530D69' variant='h4' fontWeight='800'>Page Developer</Typography>
                 <Typography color='#fff'>The sole purpose of the page is to learn and put into
                    ...
                    <Button sx={{backgroundColor: '#530D69', color: '#fff', borderRadius: '2px' , width : width > 710 ? '20%' : '40%' , height: '45px'}}>Contact me</Button>
              </Box>
    </Box>
 </Box>
  )
